...
public static class PublicExtensions
{
    ...
    public static IServiceCollection AddDatasyncServices(this IServiceCollection services, IEdmModel? model = null)
        => services.AddDatasyncServices(model, null);
    ...
    /// </summary>
    /// <param name="services">The current service collection.</param>
    /// <param name="configure">A callback used to configure Datasync service options.</param>
    /// <returns>The modified service collection.</returns>
    public static IServiceCollection AddDatasyncServices(this IServiceCollection services, Action<DatasyncServiceOptions> configure)
        => services.AddDatasyncServices(null, configure);
    ...
    /// <param name="configure">A callback used to configure Datasync service options.</param>
    /// <returns>The modified service collection.</returns>
    public static IServiceCollection AddDatasyncServices(this IServiceCollection services, IEdmModel? model, Action<DatasyncServiceOptions>? configure)
    {
        _ = services.AddSingleton<IDatasyncServiceOptions>(_ =>
        {
